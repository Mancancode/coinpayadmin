...
export default function OrderSell() {
    const columns = [
      ...
      const rows = [
       ...
       { id: 6, username: 'Melisandre', avatar: 'img', email: 'melisandre@gemial.com', status: 'pending', date: '02/03/21', coin: 'BNB', transaction: '$260.000' },
       { id: 7, username: 'Clifford Ferrara', avatar: 'img', email: 'Ferrara@gemial.com', status: 'declined', date: '02/03/21', coin: 'ADA', transaction: '$630.000' },
       { id: 8, username: 'Frances Rossini', avatar: 'img', email: 'Rossisi@gemial.com', status: 'completed', date: '02/04/21', coin: 'BTC', transaction: '$275.000' },
    ...
    return (
        <div className="orderSell">
               ...
               <div className="orderSellItem">
                
                <span className="orderSellTitle">Total Sell</span>
                <div className="orderSellMoneyContianer">
                    <span className="orderSellMoney">$400,340</span>
                    <span className="orderSellMoneyRate">
                        -131 <ArrowDownwardIcon className='orderSellIcon'/>
                        </span>
                </div>
                <span className="orderSellSub">Compared to last 24hrs</span>
                  
                </div>
                <div className="orderSellItem ">
                
                <span className="orderSellTitle">Users that Sold</span>
                <div className="orderSellMoneyContianer">
                    <span className="orderSellMoney">40,340</span>
                    <span className="orderSellMoneyRate">
                        +213 < ArrowUpwardIcon className='orderSellIcon up'/>
                        </span>
                </div>
                <span className="orderSellSub">Compared to last 24hrs</span>
                ...
                <div className="orderSellTable" style={{ height: 400, width: '100%' }}>
